...
<div class="mb-5 card mb-xl-8">
    ...
    <div class="pt-5 border-0 card-header">
        <h3 class="card-title align-items-start flex-column">
            <span class="mb-1 card-label fw-bold fs-3">Repayment Cycles</span>
            <span class="mt-1 text-muted fw-semibold fs-7">Over {{ $repayment_cycles->count() }} repayment cycle</span>
        </h3>
