                                                ...
                                                <div class="bg-white avatar-title rounded-circle">
                                                    ...
                                                    @else
                                                        @if ($loan->user->gender !== null) 
                                                            ...
                                                            @else
                                                                <img src="public/assets/images/boy.png" alt="{{ $loan->user->fname }}" class="rounded-circle avatar-lg" />
                                                            @endif
                                                        @else
                                                            <img src="public/assets/images/user.png" alt="{{ $loan->user->fname }}" class="rounded-circle avatar-lg" />
                                                        @endif
                                                    @endif
                                                </div>
                                            </div>
