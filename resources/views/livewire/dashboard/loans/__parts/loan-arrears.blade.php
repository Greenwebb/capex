<div class="tab-pane fade" id="loan-penalties" role="tabpanel">
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="text-muted">
                        <h3 class="mb-3 fw-semibold text-uppercase">Loan Penalties (Areas)</h3>
                        <br>
                        <div class="table-responsive">
                            ...
                            <h5 class="text-muted">No Running Penalties/ Arrears</h5>
                        </div>
                        ...
                        <div class="pt-3 mt-4 border-top border-top-dashed">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <p class="mb-2 text-uppercase fw-medium">Remaining Penalties:</p>
