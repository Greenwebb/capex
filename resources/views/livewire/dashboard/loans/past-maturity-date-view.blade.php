                        ...
                        <table id="fixed-header" class="table align-middle table-bordered dt-responsive nowrap table-striped" style="width:100%">
                            ...
                            <tbody>
                                @forelse($loan_requests as $loan)
                                    ...
                                    <tr>
                                        <td style="">#{{ $loan->application->loan_number }}</td>
                                        ...
                                        <td style="">{{ App\Models\Application::payback($loan->application->amount, $loan->application->repayment_plan, $loan->loan_product_id, $loan) }}</td>
